# -*- coding: utf -8 -*-
#=============导入模块===============
import pygame,sys,random,traceback,os
...
def showStartScreen():
    ...
    begin_index = 0
    begin_text = score_font.render("Have Fun!",True, color_black)
    ...
    while True:
        ...
        screen.blit(begin_text,(162,504))
...
def gameBeigin(running):
    ...
    #设置暂停键的位置
    paused_rect.left, paused_rect.top = screenwidth - paused_rect.width - 10, 10
    #设置默认显示的暂停键
